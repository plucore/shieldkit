...
- **Product matching quality.** A product with a sparse title and [missing GTIN](/fix/missing-gtin) won't surface even though the catalog itself is ingested.
...
Missing GTINs, [missing brand](/fix/missing-brand), [missing MPN](/fix/missing-mpn), [missing condition](/fix/condition-not-declared), missing material. ChatGPT's matching algorithm uses the same signals Google uses, and missing identifiers reduce match confidence. See [why "missing GTIN" shows on your Shopify Google channel](/blog/missing-gtin-shopify-fix) for the GTIN fix path and [how to add MPN and brand metafields to Shopify products](/blog/mpn-brand-metafields-shopify) for the brand+MPN substitute.
