...
If you just got the suspension email and you're trying to figure out *which* policy you tripped, the short answer is almost certainly misrepresentation, that single bucket accounts for roughly 90% of GMC suspensions on Shopify. The remaining 10% splits across [counterfeit goods](/fix/counterfeit-goods), [restricted product violations](/fix/restricted-product), [untrustworthy promotions](/fix/untrustworthy-promotions), and site-quality issues. Google's email rarely tells you the exact trigger; this post does.
...
- **[Inconsistent business info between site and feed](/fix/business-information-mismatch).** Your feed says "Acme LLC, Delaware" but your About page says "Acme Co., based in California." Pick one and use it everywhere.
- **[Missing or hidden contact information](/fix/missing-contact-information).** No phone, no domain email, no street address visible publicly. A contact form alone doesn't count.
...
- **[Price mismatches between feed and landing page](/fix/price-mismatch).** Feed says $29.99, page shows $29.99 + $4.99 mandatory "handling fee" added at checkout. Suspension.
