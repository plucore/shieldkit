...
**What Google checks:** that at least two of three [contact methods](/fix/missing-contact-information) are publicly visible, phone, email, physical street address.
...
**What Google checks:** that you have a [published refund policy](/fix/missing-refund-policy), and that the policy contains three signals, return window, item condition, refund method.
...
**What Google checks:** that delivery timeframes and [shipping costs are explicitly stated](/fix/missing-shipping-policy).
...
**What Google checks:** that your homepage shows the [payment methods you accept](/fix/missing-checkout-transparency).
...
**What Google checks:** that [any fee mentioned anywhere on your store](/fix/hidden-fees) (handling, restocking, processing, convenience, service, surcharge) is also disclosed in your shipping or refund policy.
...
**What Google checks:** whether product descriptions reference images hosted on [known dropshipper/supplier CDNs](/fix/dropshipping-cdn-images) (`cdn.cjdropshipping.com`, `alicdn.com`, `aliexpress-img.alicdn.com`, etc.).
