...
ShieldKit serves a dynamic `llms.txt` for installed merchants via App Proxy at `/apps/llms-txt`, included in the Monitoring plan. The marketing site itself uses the same approach, a route that templates from the blog and product registry.
