/**
 * app/utils/email-templates/compliance-alert.ts
 *
 * HTML template for the weekly compliance alert email sent when a
 * merchant's score drops or new issues appear.
 */
