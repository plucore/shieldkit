...
* **Count on 2026-07-30 (batch 2 completion):** **747 / 747 passing across 40 files.** (Was 329/14 on 2026-07-09 — the §14 file list above is stale beyond the nine it names; trust `ls tests/`.) The two 2026-07-30 batches added `sentry-flush.test.ts`, `scan-quota-refund.test.ts`, `scan-failure-visibility.test.ts`, `violations-scorable.test.ts`, `generated-policies-lost-update.test.ts`, `typecheck-gate.test.ts`, `page-speed-deferred.test.ts`.
